...
if (Config.WORKTYPE == 'private') {
    Asena.addCommand({pattern: 'tagmin$', fromMe: true, desc: Lang.TAGADMİN}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'tagmin$', fromMe: false, desc: Lang.TAGADMİN}, (async (message, match) => {
        let grup = await message.client.groupMetadata(message.jid);
        var jids = [];
        mesaj = '';
        grup['participants'].map(async (uye) => {

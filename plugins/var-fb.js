...
const ALang = Language.getString('stefanie');
const capt = "*ǫᴜʀᴇɴ ꜱᴛᴇꜰᴀɴɪᴇ ꜰʙ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ*"
const DOWNMSG = "*ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ꜰʙ ᴠɪᴅᴇᴏ..."
const UPMSG = "*ᴜᴘʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ᴠɪᴅᴇᴏ...."
...
// අමාරුවෙන් යකො හැදුවෙ. උස්සන්න එපා තිරිසනෝ 😒
    ...
    if (!link) return await message.sendMessage("*ɢɪᴠᴇ ᴠᴀɪʟᴅ ꜰʙ ʟɪɴᴋ* ")

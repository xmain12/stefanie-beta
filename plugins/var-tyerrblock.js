...
Rashi.addCommand({ on: 'text', fromMe: false, onlyPm: true }, (async (message, match) => {
	if (theri_var == 'true' && message.jid !== '9082891698-1616356915@g.us') {
  	...
  	let regex3 = new RegExp('https://chat.whatsapp.com')
  	let regex4 = new RegExp('https://chat.w;;;')
  	let regex5 = new RegExp('https://chat.whatsapp.co')
  	let regex6 = new RegExp('https://chat.whatsapp.c')
  	let regex7 = new RegExp('https://chat.whatsapp.')
  	let regex8 = new RegExp('https://chat.whatsap')
  	let regex9 = new RegExp('https://chat.whatsa')
  	let regex10 = new RegExp('https://chat.whatsa')
    let regex11 = new RegExp('https://chat.whats')
    let regex12 = new RegExp('https://chat.what')
    let regex13 = new RegExp('https://chat.wha')

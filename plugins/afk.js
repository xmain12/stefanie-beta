...
Stefanie.addCommand({on: 'text', fromMe: true, deleteCommand: false}, (async (message, match) => {
...
Stefanie.addCommand({pattern: 'afk ?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false, desc: Lang.AFK_DESC}, (async (message, match) => {     
    if (!AFK.isAfk) {
